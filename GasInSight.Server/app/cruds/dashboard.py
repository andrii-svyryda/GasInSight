...
class CrudDashboard:
    async def get_dashboard_data(self, db: AsyncSession, user_id: int | None = None) -> DashboardData:
        metrics = await self.get_dashboard_metrics(db, user_id)
        chart_data = await self.get_dashboard_chart_data(db, user_id)
    ...
    async def get_facility_dashboard_data(self, db: AsyncSession, facility_id: str, user_id: int | None = None) -> DashboardData:
        metrics = await self.get_dashboard_metrics(db, user_id, facility_id)
        chart_data = await self.get_dashboard_chart_data(db, user_id, facility_id)
    ...
    async def get_dashboard_metrics(self, db: AsyncSession, user_id: int | None = None, facility_id: str | None = None) -> DashboardMetrics:
    ...
    async def get_dashboard_chart_data(self, db: AsyncSession, user_id: int | None = None, facility_id: str | None = None) -> DashboardChartData:
        facilities_query = select(Facility)
